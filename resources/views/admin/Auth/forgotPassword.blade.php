    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                {{-- <p class="login-box-msg">You forgot your password? Here you can easily retrieve a new passwor3d.</p> --}}
                @if (session('success'))
                ...
                <form action="{{ route('admin.forgott.password.post') }}" method="post">
                    @csrf
